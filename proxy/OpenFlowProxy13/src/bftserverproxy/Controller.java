...
public class Controller {
	...
	public void setUpConnection(int clientID, BFTServerControl control, OpenFlowPacketParser parser, OFVersion version) {
		Socket sock = null;
		try {
		...
		this.connection = new ServerConnection(clientID, IP, sock, control, this, parser, version);
